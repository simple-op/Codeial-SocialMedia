    ...
    $.ajax({
        ...
        success:function(data){
         if(data.data.posts)
            {   let postList=$("#posts"); 
                ...
                disableDefaultComments(`#${data.data.posts._id}`)
                
                disableDefault(`#comment${data.data.posts._id}`);
        ...
        let appendPost=function(postData){
           ...
           <li><p>${postData.content}
                   ...
                   <a id="${postData._id}" onclick="deletePost(this)" href="/deletePost/?id=${postData._id}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
let disableDefaultComments=function(element){
...
let disableDefault=function(element){
...
// comment addition with ajax
  ...
  let appendComment=function(data){
       return (`<li> ${data.content}  <span>
         ...
         <a class="deleteNewComments" onclick="deleteCommentAtPost(this)" href="/deleteComment?id=${data.id}&postId=${data.post}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
disableDefault(".commentList");


disableDefaultComments(".deleteComments")
disableDefaultComments(".postDeleteLink")



function deleteCommentAtPost(element){
